...
function get_cloud_list(unique_id, get, localsite) {
    $.ajax({
        type: 'GET',
        url: 'https://api.dou.co/extend.list',
...
function fetch_system_update(localsystem) {
    $.ajax({
        type: 'GET',
        url: 'https://api.dou.co/system.update',
...
function fetch_module_update(localsite) {
    $.ajax({
        type: 'GET',
        url: 'https://api.dou.co/module.update',
 ...
 * 写入可更新数量
 +----------------------------------------------------------
 */
function fetch_update_number(localsite) {
    $.ajax({
        type: 'GET',
        url: 'https://api.dou.co/connect.dou',
        data: {'localsite':localsite},
        dataType: 'jsonp',
        jsonp: 'jsoncallback',
        success: function(cloud) {
